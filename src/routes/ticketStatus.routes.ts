...
import { httpGet, httpGetById, httpPost, httpPut, httpDelete } from '../httpCallbacks/ticketStatus.callbacks'
import { validatorRequest, validateExistsEntity, createEntity } from '../middlewares/ticketStatus.middlewares'
